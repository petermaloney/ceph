...
int ceph_ll_lookupx(struct ceph_mount_info *cmount,
...
int ceph_ll_mknod(struct ceph_mount_info *cmount, struct Inode *parent,
		  ...
		  int uid, int gid);
int ceph_ll_mknodx(struct ceph_mount_info *cmount, Inode *parent,
...
int ceph_ll_symlinkx(struct ceph_mount_info *cmount,
